...
nohup python -u RL/agent/high_level.py --exp 'exp3' --dataset 'ETHUSDT' --transcation_cost 0.0005 --action_mode long --action_size 1 >./logs/high_level/ETHUSDT/exp3.log 2>&1 &
