...
nohup python -u RL/agent/high_level.py --exp 'both_action_3' --dataset 'ETHUSDT' --transcation_cost 0.0005 --action_mode both --action_size 2 --reward_no_action False >./logs/high_level/ETHUSDT/both_action_3.log 2>&1 &
