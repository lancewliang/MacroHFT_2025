#nohup python -u RL/agent/high_level.py --exp 'both_action' --dataset 'ETHUSDT' --transcation_cost 0.0005 --action_mode both --action_size 1 >./logs/high_level/ETHUSDT/both_action_1.log 2>&1 &
...
nohup python -u RL/agent/high_level.py --exp 'short_action_3' --dataset 'ETHUSDT' --transcation_cost 0.0005 --action_mode short --action_size 1 --reward_no_action False >./logs/high_level/ETHUSDT/short_action_3.log 2>&1 &
