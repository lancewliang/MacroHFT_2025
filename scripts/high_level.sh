...
nohup python -u RL/agent/high_level.py --exp 'exp4_4' --dataset 'ETHUSDT' --transcation_cost 0.0002 --action_mode long --action_size 1 --reward_no_action False >./logs/high_level/ETHUSDT/exp4_4.log 2>&1 &
