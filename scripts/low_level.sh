...
nohup python -u RL/agent/low_level.py --alpha 1 --exp 'both_action_1' --clf 'slope' --dataset 'ETHUSDT' --device 'cuda:0' --transcation_cost 0.0005 --action_mode both --action_size 1 --label label_2 >./logs/low_level/ETHUSDT/1.log 2>&1 &
nohup python -u RL/agent/low_level.py --alpha 1 --exp 'both_action_2' --clf 'slope' --dataset 'ETHUSDT' --device 'cuda:0' --transcation_cost 0.0005 --action_mode both --action_size 2 --label label_2 >./logs/low_level/ETHUSDT/2.log 2>&1 &
